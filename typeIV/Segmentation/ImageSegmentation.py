...
def read_log(path):
    ...
    for row in rows:
        ...
        data.append([row_value[0], row_value[1], row_value[2]])
        count += 1
    print("读取日志的次数", count)
    return data
...
def write_image(array, date, save_path):
    ...
    if not array:
        ...
        name_save = "LM{:4d}{:0>2d}{:0>2d}{:0>2d}{:0>2d}.jpg"
...
if __name__ == '__main__':
    path_read = r"G:\LearmonthData\learmonth原始数据\{:0>4d}"
    path_save = r"G:\LearmonthData\IV"
    path_log = r'C:\Users\dell\Desktop\IVSegmentationTime.xlsx'
